...
// Default matches upstream Dumper-7's Settings::Generator::SDKGenerationPath.
// Our DllMain shim (main.cpp) overrides this at load time from the
// DUMPER7_OUTPUT_ROOT environment variable when set — see main.cpp.
std::string Generator::SDKFolder = "C:/Dumper-7";
