...
void register_routes(httplib::Server& server) {
    ...
    server.Get("/api", [](const httplib::Request&, httplib::Response& res) {
        ...
        result["endpoints"] = json::array({
            ...
            "/api/render/d3d12", "/api/render/root-signatures", "/api/render/shaders", "/api/render/preview",
            "/api/render/context", "/api/render/sn2-state", "/api/render/selected-resource",
            ...
            "/api/render/select-eye", "/api/render/stereo-forensics",
            "/api/render/stereo-forensics/arm", "/api/render/renderdoc/status",
            ...
            "/api/render/hunter/highlight", "/api/render/hunter/skip-eye"
        });
