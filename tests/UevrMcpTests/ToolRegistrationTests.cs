...
public class ToolRegistrationTests
{
    ...
    static readonly HashSet<string> ExpectedRenderTools = new()
    {
        ...
        "uevr_render_write_dxil_transform", "uevr_render_write_dxil_semantic_transform",
        "uevr_render_write_per_eye_shader_payloads",
        ...
        "uevr_render_pipeline_cache_events", "uevr_render_override_status",
        "uevr_render_stereo_summary", "uevr_render_select_eye",
        "uevr_render_stereo_forensics", "uevr_render_stereo_forensics_arm",
        ...
        "uevr_render_eye_pixel_sample", "uevr_render_ab_pixel_diff", "uevr_render_eye_dump",
        ...
        "uevr_render_llm_frame_investigator", "uevr_render_make_fix_candidate",
        "uevr_render_capture_investigation_bundle", "uevr_render_diagnose_shader_issue",
